...
cd Haulage
dotnet build -t:InstallAndroidDependencies -f:net8.0-android -p:AndroidSdkDirectory="/usr/lib/android-sdk" -p:JavaSdkDirectory="/usr/lib/jvm" -p:AcceptAndroidSDKLicenses=True
